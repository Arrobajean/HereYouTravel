    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          {/* Icono y título */}
          <div
            className={`flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-6 w-full px-4 py-2 overflow-visible transition-all ${
          ...
          >
            ...
            />
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white font-montserrat text-center sm:text-left">
